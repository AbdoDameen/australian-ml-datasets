...
def _():
    ...
    print("     marimo edit risk-prediction/project1_fire_risk.py")
    print("     marimo edit resource-allocation/project2_resource_allocation.py")
    print("     marimo edit burn-scar-mapping/project3_burn_scar.py")
    print("     marimo edit dashboard/project4_dashboard.py")
